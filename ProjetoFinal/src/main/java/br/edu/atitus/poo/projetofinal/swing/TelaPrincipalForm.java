...
public class TelaPrincipalForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuDepartamento.setText("Departamentos");
    ...
    private void mnuDepartamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuDepartamentoActionPerformed
        DepartamentoForm departamentoForm = new DepartamentoForm();
        jDesktopPane1.add(departamentoForm);
        departamentoForm.setVisible(true);
    }//GEN-LAST:event_mnuDepartamentoActionPerformed

    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        UsuarioForm usuarioForm = new UsuarioForm();
        jDesktopPane1.add(usuarioForm);
